...
export const Faq = ({variants, className}) => {
  return (
    <section className="page-container border border-black/8 dark:border-white/14 grid md:grid-cols-2">
      ...
      <div className="">
        <Accordian items={variants} className="" />
      </div>
    </section>
  );
};
