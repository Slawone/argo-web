...
const tabs = [
  {
    ...
    leftText: (
      <>
        ...
        существенно оптимизировала процессы резервного копирования данных.
        Благодаря внедрению системы хранения данных АРГО с полезным объёмом
        свыше 1 ПБ удалось добиться двукратного ускорения работы{" "}
        <span className="title-color">Veeam Backup.</span>
      </>
    ),
    rightText: (
      <>
