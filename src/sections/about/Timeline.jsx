...
import { Help, NewVersion, Separator_1, Separator_2, Separator_3, Version } from "@/ui/svg";
    ...
    <section className="section-border page-container section-py relative">
      ...
      <div className="flex flex-col gap-10 px-8">
        <div className="text-color mb-5 md:grid md:grid-cols-[300px_2fr]">
          <div className="mb-5 text-center md:text-left">
            <h3 className="text-lg md:text-xl lg:text-2xl xl:text-3xl">
              Начало пути <br /> <span className="title-color">Первые шаги</span>
            </h3>
          </div>
        ...
        <div className="text-color mb-5 md:grid md:grid-cols-[300px_2fr]">
          ...
          <div className="flex flex-col gap-5 main-text">
            <p className="mb-5 md:mb-10">Где еще может помочь AI.ARGO</p>
            <Help />
        ...
        <div className="text-color mb-5 md:grid md:grid-cols-[300px_2fr]">
          ...
          <div className="flex flex-col gap-5 main-text">
            <p className="mb-5 md:mb-10">
              Новая платформа хранения <span className="title-color">ISCRA</span>. Новая версия решения <span className="title-color">STORAGE</span>.
              Запуск решения на Альтернативных платформах. Новые ИИ-решения в
              Реестре. Запуск продукта <span className="title-color">РЕ:Сурс</span>.
            </p>
            ...
            <p className="">
              Еще больше функциональных возможностей в новой версии <span className="title-color">STORAGE</span>, будут доступны для всех инсталированых систем
            </p>
