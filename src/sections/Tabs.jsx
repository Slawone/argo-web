  ...
  return (
    <section className="section-border mx-auto relative">
      <div className="md:grid md:grid-cols-[7fr_5fr] relative">
        ...
        <div className="w-full px-4 py-5 md:border-r md:border-r-black/8 md:dark:border-white/14 h-30 md:h-80 md:pt-20">
        ...
        {/* right */}
        <div className="w-full px-4 py-5 mb-10 md:mb-0 h-30 md:h-80 md:pt-20 relative">
          <AnimatePresence mode="wait">
            <motion.div
              key={active.id + "right"}
              className="relative"
